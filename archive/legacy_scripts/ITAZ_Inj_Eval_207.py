...
[✅] Ergebnisse werden von den Messdaten getrennt und in einem Unterordner "Results" abgespeichert.
        Diese Variante ist besser als die Rohdaten zu verschieben. Bei einer Mehrfachauswertung wäre das ungünstig
[✅] Neue Funktion für Gain und Rate-Down Kurvenauswertung
"""
...
from Fkt.ICS_Eval04 import analyze_plateaus
from Fkt.InjRate02 import InjectionRate
from Fkt.Fig01 import plot_signals
from Fkt.GainFig04 import GainCurve
from Fkt.InjLift04 import analyze_and_plot_needle_lifts
...
def run_main_analysis(cfg):
    ...
    result_folder = os.path.join(ordnerpfad, "Results")  # <-- geändert
    ...
    # Diagramm speichern im Results-Ordner
