"""
[✅] Nächste Schritte für GainFig03, zwei Arten von Gain. 
[✅] Var1: Stromzeit ändert sich
[✅] Var2: Strom bleibt gleich; Druck ändert sich --> NEUE RateDownCurve01 Funktion erstellt
[✅] Für die Menge mg den Wert nach dem Injektorprellen nutzen
"""
import numpy as np
import matplotlib.pyplot as plt
import os

def GainCurve(signal_dict, T, step_size, ICS_Eval_Result, hub_times, ordnerpfad=None, regression_type="linear", auto_select=False):
    try:
