...
def RateDownCurve(signal_dict, T, step_size, hub_times, ordnerpfad=None,
    ...
    # Setze Achsen mit etwas Puffer (60 % des Bereichs)
    ...
    # Speichern als PNG im Bilder-Ordner
    ...
    fig.update_layout(title=f"Rate Down Curve: Systemdruck vs. Injection Mass ({ordnername})",
                      xaxis_title="System Pressure (abs_bar)",
                      yaxis_title="Mass (mg)")
    
    # Achsenlimits für Plotly
